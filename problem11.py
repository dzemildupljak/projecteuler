...
for i in range(len(grid_lines)):
    line_list = grid_lines[i].split(' ')
    grid_matrix.append(line_list)

for i in range(len(grid_matrix)):
    for j in range(len(grid_matrix[i])):
        grid_matrix[i][j] = int(grid_matrix[i][j])


# products = []
# products.append(VerticalRow(grid_matrix))
# products.append(HorizontalRow(grid_matrix))
# products.append(DiagonalRight(grid_matrix))
# products.append(DiagonalLeft(grid_matrix))

# print(max(products))
print(Prod(grid_matrix))
